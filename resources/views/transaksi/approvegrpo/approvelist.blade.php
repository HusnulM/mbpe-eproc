...
@section('title', 'List Approve Receipt PO')
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">List Approve Receipt PO</h3>
    ...
    $(document).ready(function(){
        ...
        function loadDocument(_params){
            ...
            $("#tbl-budget-list").DataTable({
                serverSide: true,
                ajax: {
                    url: base_url+'/approve/grpo/listopengrpo'+_params,
                    data: function (data) {
                        data.params = {
                            sac: "sac"
                        }
            ...
            $('#tbl-budget-list tbody').on( 'click', '.button-detail', function () {
                ...
                window.location = "/approve/grpo/details/"+selected_data.grid;
            });
        }
