...
@section('title', 'Receipt PO Approval')
...
<div class="container-fluid">
    <div class="row">
        <div class="col-lg-3">
            <form action="{{ url('/approve/grpo/save') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Approve Receive PO <b>[ {{ $header->docnum }} ]</b></h3>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="form-group">
                                    <label for="doctitle">Receive Number</label>
                                    <p>{{ $header->docnum }}</p>
                                    <input type="hidden" id="docnum" value="{{ $header->docnum }}">
                                    <input type="hidden" id="docyear" value="{{ $header->docyear }}">
                                </div>
                                <div class="form-group">
                                    <label>Receive By:</label> {{$header->received_by}}
                                </div>
                                <div class="form-group">
                                    <label>Receive Date:</label>
                                    <p>{!! formatDateTime($header->postdate) !!}
                                    </p>
                                </div>
                                <div class="form-group">
                                    <label>Remark</label>
                ...
                <div class="card-header">
                    ...
                    <div class="row">
                        <ul class="nav nav-tabs" id="custom-content-above-tab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="custom-content-above-home-tab" data-toggle="pill" href="#custom-content-above-home" role="tab" aria-controls="custom-content-above-home" aria-selected="true">GR Items</a>
                            </li>
                            <li class="nav-item">
                    ...
                    <div class="card-tools">
                        <a href="{{ url('/approve/grpo') }}" class="btn btn-default btn-sm">
    ...
    $(document).ready(function () {
        ...
        function approveOpnam(){
            var prtemchecked = {
                ...
                $.ajax({
                    url:base_url+'/approve/grpo/save',
                    method:'post',
                    data:prtemchecked,
                    dataType:'JSON',
                    beforeSend:function(){
                    ...
                    if(response.msgtype === "200"){
                        ...
                        setTimeout(function(){
                            window.location.href = base_url+'/approve/grpo';
                        }, 2000);
                    }else{
