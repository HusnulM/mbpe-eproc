            ...
            <form action="{{ url('/approve/bast/save') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Approve BAST <b>[ {{ $header->no_bast }} ]</b></h3>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <p>{!! formatDateTime($header->tanggal_bast) !!}
                                    </p>
                                </div>
                                <div class="form-group">
                                    <label>Remark</label>
                ...
                <div class="card-header">
                    ...
                    <div class="row">
                        <ul class="nav nav-tabs" id="custom-content-above-tab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="custom-content-above-home-tab" data-toggle="pill" href="#custom-content-above-home" role="tab" aria-controls="custom-content-above-home" aria-selected="true">BAST Items</a>
                            </li>
                            <li class="nav-item">
                    ...
                    <div class="card-tools">
                        <a href="{{ url('/approve/bast') }}" class="btn btn-default btn-sm">
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <table id="tbl-pr-data" class="table table-bordered table-hover table-striped table-sm">
                                                <thead>
                                                    ...
                                                    <th>Item Code</th>
                                                    <th>Item Name</th>
                                                    <th style="text-align:center;">BAST Quantity</th>
                                                    <th>Unit</th>
                                                    <th>PBJ Number</th>
                                                </thead>
                                                <tbody>
    ...
    $(document).ready(function () {
        ...
        function approveOpnam(){
            var prtemchecked = {
                ...
                $.ajax({
                    url:base_url+'/approve/bast/save',
                    method:'post',
                    data:prtemchecked,
                    dataType:'JSON',
                    beforeSend:function(){
                    ...
                    if(response.msgtype === "200"){
                        ...
                        setTimeout(function(){
                            window.location.href = base_url+'/approve/bast';
                        }, 2000);
                    }else{
