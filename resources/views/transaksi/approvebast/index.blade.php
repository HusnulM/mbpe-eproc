...
@section('title', 'List Approve BAST')
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">List Approve BAST</h3>
    ...
    $(document).ready(function(){
        ...
        function loadDocument(_params){
            ...
            $("#tbl-budget-list").DataTable({
                serverSide: true,
                ajax: {
                    url: base_url+'/approve/bast/listopenbast'+_params,
                    data: function (data) {
                        data.params = {
                            sac: "sac"
                        }
                ...
                columns: [
                    ...
                    {data: "tanggal_bast", className: 'uid',
                        render: function (data, type, row){
                            return ``+ row.tanggal_bast.tanggal_bast + ``;
                        }
                    },
                    {data: "pemberi"},
            ...
            $('#tbl-budget-list tbody').on( 'click', '.button-detail', function () {
                ...
                window.location = "/approve/bast/details/"+selected_data.bast_id;
            });
        }
