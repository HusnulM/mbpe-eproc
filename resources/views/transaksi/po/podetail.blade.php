                                                ...
                                                <div class="col-lg-12">
                                                    <div class="tab-content" id="custom-content-above-tabContent">
                                                        ...
                                                        <div class="tab-pane fade" id="custom-content-above-cost" role="tabpanel" aria-labelledby="custom-content-above-cost-tab">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-12">
                                                                    <input type="checkbox" id="isPOSolar" class="filled-in" readonly {{ $pohdr->is_posolar == 'Y' ? 'checked' : '' }} />
                                                                    ...
                                                                    <table class="table table-sm">
                                                                        ...
                                                                        <tbody id="tbl-cost-body">
                                                                            ...
                                                                            <tr>
                                                                                <td>OAT ( % )</td>
                                                                                <td>
                                                                                    <input type="text" class="form-control" name="solaroat" value="{{ $pohdr->solar_oat }}" readonly>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td>PPN OAT ( % )</td>
