    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <ul class="nav nav-tabs" id="custom-content-above-tab" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link" id="custom-content-above-grpo-tab" data-toggle="pill" href="#custom-content-above-grpo" role="tab" aria-controls="custom-content-above-grpo" aria-selected="false">Receipt PO</a>
                </li>
                <li class="nav-item">
            ...
            <div class="tab-content" id="custom-content-above-tabContent">
                ...
                {{-- GR PO --}}
                <div class="tab-pane fade" id="custom-content-above-grpo" role="tabpanel" aria-labelledby="custom-content-above-grpo-tab">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <div class="card-tools">
                                    <button type="button" class="btn btn-primary btn-sm btn-add-grpo-approval">
                                        <i class="fas fa-plus"></i> Tambah Approval Receipt PO
                                    </button>
                                </div>
                            </div>
                            <div class="card-body">
                                <table id="tbl-worflow-grpo" class="table table-bordered table-hover table-striped table-sm" style="width:100%;">
                                    <thead>
                                        <th>No</th>
                                        <th>Creator</th>
                                        <th>Approver</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $row->approver_level }}</td>
                                            <td style="text-align:center;">
                                                <a href="{{ url('config/workflow/deletegrpowf/') }}/{{$row->id}}" class='btn btn-danger btn-sm button-delete'>
                                                    <i class='fa fa-trash'></i> DELETE
                                                </a>
                                            </td>
                                        </tr>
                ...
                {{-- BAST --}}
                <div class="tab-pane fade" id="custom-content-above-bast" role="tabpanel" aria-labelledby="custom-content-above-bast-tab">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <div class="card-tools">
                                    <button type="button" class="btn btn-primary btn-sm btn-add-bast-approval">
                                        <i class="fas fa-plus"></i> Tambah Approval BAST
                                    </button>
                                </div>
                            </div>
                            <div class="card-body">
                                <table id="tbl-worflow-bast" class="table table-bordered table-hover table-striped table-sm" style="width:100%;">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $row->approver_level }}</td>
                                            <td style="text-align:center;">
                                                <a href="{{ url('config/workflow/deletebastwf/') }}/{{$row->id}}" class='btn btn-danger btn-sm button-delete'>
                                                    <i class='fa fa-trash'></i> DELETE
                                                </a>
                                            </td>
                                        </tr>
...
<div class="modal fade" id="modal-add-approval">
    <form action="{{ url('config/workflow/savewf') }}" method="post">
        @csrf
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title" id="title-add-approval">Tambah Approval</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-lg-12" style="display: none;">
                        <input type="text" name="wfobject" id="wfobject" class="form-control" readonly>
                    </div>
                    <div class="col-lg-12">
                        <table class="table table-bordered table-hover table-striped table-sm" style="width:100%;">
                            <thead>
                                ...
                                <th>Approval Level</th>
                                <th style="width:50px; text-align:center;">
                                    <button type="button" class="btn btn-success btn-sm btn-add-new-wf">
                                        <i class="fa fa-plus"></i>
                                    </button>
                                </th>
                            </thead>
                            <tbody id="tbl-add-approval-body">
...
<script>
    $(document).ready(function(){
        ...
        $('.btn-add-grpo-approval').on('click', function(){
            $('#wfobject').val('GRPO');
            $('#title-add-approval').html('');
            $('#title-add-approval').html('Tambah Approval Receipt PO');
            $('#modal-add-approval').modal('show');
        });

        $('.btn-add-bast-approval').on('click', function(){
            $('#wfobject').val('BAST');
            $('#title-add-approval').html('');
        ...
        $('.btn-add-new-wf').on('click', function(){
            $('#tbl-add-approval-body').append(`
                <tr>
                    <td>
